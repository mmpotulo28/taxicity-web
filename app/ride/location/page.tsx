...
const LocationPicker: React.FC = () => {
  ...
  const { setPickupLocation, setDropOffLocation, selectedRoute, selectedRank } =
    useRide();
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-default-500 mt-1">
                This route operates from 5:00 AM to 8:00 PM daily. Taxis
                typically depart every 15-20 minutes when full. Cash payment is
                accepted on board.
              </p>
            </div>
          </div>
