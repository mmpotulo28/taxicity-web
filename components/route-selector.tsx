...
interface RouteSelectorProps {
  onRouteSelect: (route: string, rank: string) => void;
}
        ...
        <div className="space-y-3">
          ...
          {filteredRoutes.length === 0 && (
            <div className="text-center py-8">
              <Icon icon="lucide:search-x" className="text-4xl text-default-300 mx-auto mb-2" />
              <p className="text-default-500">No routes found matching "{searchQuery}"</p>
            </div>
          )}
        </div>
      </div>
