...
const DriverTabs = () => {
 ...
 return (
  <View className="fixed bottom-0 left-0 right-0 z-50 bg-background border-t border-default-200 shadow-lg h-16 rounded-t-2xl pb-safe">
    ...
    {tabs.map((tab) => {
     ...
     return (
      <Button
       ...
       {!tab.main && (
        <Text className="text-[10px] leading-none">
         {tab.label}
        </Text>
       )}
      </Button>
