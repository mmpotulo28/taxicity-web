				...
				<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
					<div className='text-center max-w-4xl mx-auto'>
						...
						<h1 className='text-6xl md:text-8xl font-black tracking-tighter text-default-900 dark:text-white mb-8 leading-[0.9]'>
							Ride Smart <br />
							<span className='text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary-500'>Move Faster</span>
						</h1>

						<p className='text-xl md:text-2xl text-default-700 mb-12 leading-relaxed max-w-2xl mx-auto font-light'>The all-in-one platform revolutionizing the minibus taxi industry. Seamless payments, real-time tracking, and verified safety.</p>

						<div className='flex flex-col sm:flex-row gap-4 justify-center items-center'>
							<Button as={Link} href='#download' variant='solid' color='primary' size='lg'>
								Download App
								<ArrowRight className='ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform' />
							</Button>
							<Button as={Link} href='#download' variant='bordered' color='default' size='lg'>
								Web Access
							</Button>
						</div>
					</div>
			...
			<section id='download' className='py-24 bg-default-100'>
				<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
					<div className='text-center mb-20'>
						...
						<p className='text-default-700 max-w-2xl mx-auto text-lg'>Three powerful apps working in perfect sync to keep the city moving.</p>
					</div>

					<div className='grid grid-cols-1 lg:grid-cols-3 gap-12'>
						{/* User App Card */}
						<AppCard title='TaxiCiTi User' role='Commuter' description='Book seats, pay with your wallet, and track your ride in real-time.' features={["Live Tracking", "Cashless Pay", "Panic Button"]} color='bg-primary-600' link='https://linkflow.mpotulo.com/taxiciti-app' mockupColor='bg-default-900' />

						{/* Driver App Card */}
						<AppCard title='TaxiCiTi Driver' role='Driver' description='Manage trips, accept digital payments, and optimize your routes.' features={["Trip Management", "Earnings Dashboard", "Navigation"]} color='bg-primary' textColor='text-black' link='https://linkflow.mpotulo.com/taxiciti-driver' mockupColor='bg-secondary' isDarkText />
					</div>
				</div>
			</section>
						...
						<div className='md:row-span-2 bg-black dark:bg-default-900 border border-default-100 dark:border-default-800 rounded-[2.5rem] p-12 relative overflow-hidden'>
							...
							<div className='relative z-10 h-full flex flex-col justify-between'>
								<div>
									...
									<p className='text-default-400 text-lg'>Every driver is verified. Every trip is monitored. Built with safety as the foundation.</p>
								</div>
								<div className='mt-8'>
	...
	return (
		<div className='flex flex-col h-full bg-white dark:bg-black rounded-3xl overflow-hidden border border-default-200 hover:border-primary/50 transition-colors shadow-2xl hover:shadow-primary/10 duration-500 group'>
			...
			<div className='p-8 flex-1 flex flex-col'>
				<div className='mb-6'>
					<span className={`inline-block py-1 rounded-full text-xs font-bold tracking-wider uppercase mb-1 text-primary`}>{role}</span>
