    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
     ...
     <div>
      ...
      <ul className="space-y-3 text-sm text-default-800">
       <li><Link href="https://app.taxyciti.net" className="hover:text-primary transition-colors">Passenger App</Link></li>
       <li><Link href="https://driver.taxyciti.net" className="hover:text-primary transition-colors">Driver Portal</Link></li>
       <li><Link href="https://admin.taxyciti.net" className="hover:text-primary transition-colors">Operator Dashboard</Link></li>
      </ul>
     </div>
