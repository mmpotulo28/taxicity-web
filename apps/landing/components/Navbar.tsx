    ...
    <div className="flex justify-between items-center h-16">
     ...
     <div className="flex items-center gap-4">
      <Link
       ...
       className="text-sm font-medium text-default-800 hover:text-primary hidden sm:block"
      >
       Sign In
      </Link>
      <ThemeSwitch />
      <Link
       href="#download"
       className="bg-primary text-white px-5 py-2.5 rounded-full font-medium text-sm hover:bg-default-800 dark:hover:bg-default-200 transition-all shadow-lg shadow-default-200 dark:shadow-none"
      >
       Get Started
      </Link>
     </div>
